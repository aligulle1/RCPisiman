...
LANGUAGES = {
    "ar_EG"    : Language("sy",         "iso01.16",   "8859-6", "ar_EG.UTF-8"),
    "ast_ES"   : Language("ES",         "iso01.15",   "8859-15","ast_ES.utf8"),
    "bg_BG"    : Language("bg",         "cp1251",     "",        "bg_BG.utf8"),
    "cs_CZ"    : Language("CZ",         "",           "8859-2",  "cs_CZ.utf8"),
    "da_DK"    : Language("dk",         "",           "8859-1",  "da_DK.utf8"),
    "es_US"    : Language("us",         "",           "8859-1",  "es_US.utf8"),
    "eu_ES"    : Language("es",         "",           "8859-1",  "eu_ES.utf8"),
    "he_IL"    : Language("il",         "",           "8859-8",  "he_IL.utf8"),
    "hi_IN"    : Language("in",         "",           "",        "hi_IN.utf8"),
    "hr_HR"    : Language("hr",         "",           "8859-2",  "hr_HR.utf8"),
    "id_ID"    : Language("id",         "",           "8859-1",  "id_ID.utf8"),
    "is_IS"    : Language("is",         "",           "8859-1",  "is_IS.utf8"),   
    "ja_JP"    : Language("jp",         "",           "",        "ja_JP.utf8"),
    "lt_LT"    : Language("lt",         "",           "8859-13", "lt_LT.utf8"),
    "mr_IN"    : Language("in",         "",           "",        "mr_IN.utf8"),
    "nl_NL"    : Language("nl",         "",           "8859-1", " nl_NL.utf8"),
    "pt_PT"    : Language("pt",         "",           "8859-1",  "pt_PT.utf8"),
    "ro_RO"    : Language("ro",         "",           "8859-2",  "ro_RO.utf8"),
    "th_TH"    : Language("th",         "",           "tis620",  "th_TH.utf8"),
    "zh_CN"    : Language("tw",         "",           "",        "zh_CN.utf8"),
    "zh_TW"    : Language("cn",         "",           "",        "zh_TW.utf8"),
    "ca_ES"    : Language("es",         "iso01.16",   "8859-1", "ca_ES.UTF-8"),
    "de_DE"    : Language("de",         "iso01.16",   "8859-1", "de_DE.UTF-8"),
    "el_GR"    : Language("gr",         "iso07u-16",  "",       "el_GR.UTF-8"),
    "en_US"    : Language("us",         "iso01.16",   "8859-1", "en_US.UTF-8"),
    "es_ES"    : Language("es",         "iso01.16",   "8859-1", "es_ES.UTF-8"),
    "fr_FR"    : Language("fr",         "iso01.16",   "8859-1", "fr_FR.UTF-8"),
    "hu_HU"    : Language("hu",         "lat2a-16",   "8859-2", "hu_HU.UTF-8"),
    "it_IT"    : Language("it",         "iso01.16",   "8859-1", "it_IT.UTF-8"),
    "nl_NL"    : Language("nl",         "iso01.16",   "8859-1", "nl_NL.UTF-8"),
    "pl_PL"    : Language("pl",         "iso02.16",   "8859-2", "pl_PL.UTF-8"),
    "pt_BR"    : Language("br-abnt2",   "iso01.16",   "8859-1", "pt_BR.UTF-8"),
    "ru_RU"    : Language("ru",         "Cyr_a8x16",  "8859-5", "ru_RU.UTF-8"),
    "sv_SE"    : Language("sv-latin1",  "lat0-16",    "8859-1", "sv_SE.UTF-8"),
    "tr_TR"    : Language("trq",        "lat5u-16",   "8859-9", "tr_TR.UTF-8"),
}
